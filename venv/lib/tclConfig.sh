...
# installed.
TCL_PREFIX='/Users/mw-user/Downloads/ProtiGenie/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/mw-user/Downloads/ProtiGenie/venv'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/mw-user/Downloads/ProtiGenie/venv/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_c2tv246l1c/croot/tk_1714770557340/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Users/mw-user/Downloads/ProtiGenie/venv=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/mw-user/Downloads/ProtiGenie/venv/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/mw-user/Downloads/ProtiGenie/venv/lib -L/Users/mw-user/Downloads/ProtiGenie/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/mw-user/Downloads/ProtiGenie/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/mw-user/Downloads/ProtiGenie/venv/include'
...
TCL_PACKAGE_PATH='{/Users/mw-user/Downloads/ProtiGenie/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/mw-user/Downloads/ProtiGenie/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/mw-user/Downloads/ProtiGenie/venv/lib/libtclstub8.6.a'
